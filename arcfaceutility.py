...
#app = FaceAnalysis(name='r100_ms1mv3', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
#app = FaceAnalysis(name='r34_glint360k', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
#app = FaceAnalysis(name='r50_vgg2', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
#app = FaceAnalysis(name='r100_ms1mv2', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
#app = FaceAnalysis(name='r50_cisia', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
#app = FaceAnalysis(name='r50_glintasia', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
#app = FaceAnalysis(name='ms1m_megaface_r50', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
#app = FaceAnalysis(name='ms1mv2_r50', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
#app = FaceAnalysis(name='ms1mv3_r50', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
#app = FaceAnalysis(name='r34_ms1mv3', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
#app = FaceAnalysis(name='r18_ms1mv3', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
#app = FaceAnalysis(name='buffalo_l', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
#app = FaceAnalysis(name='r100_glint360k', providers=['CUDAExecutionProvider', 'CPUExecutionProvider'])
